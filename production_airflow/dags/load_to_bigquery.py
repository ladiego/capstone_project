...
from helper.extract_from_sql import extract_table
from helper.create_dataset_table import create_dataset_if_not_exists, create_table_if_not_exists

logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')

BIGQUERY_KEY_PATH = os.getenv("BIGQUERY_KEY_PATH", "/opt/airflow/keys/gcp_keys.json")
BIGQUERY_PROJECT = "purwadika"
BIGQUERY_DATASET = "diego_perpustakaan_capstone3"
